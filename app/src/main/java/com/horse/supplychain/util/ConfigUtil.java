...
public class ConfigUtil {
    ...
    public static @Property String appId;
    public static @Property String appName;
    public static @Property String serverUrl;
    public  @Property String loginUrl;
    public  @Property String apkCheckUrl;
    public  @Property String resourcePkgCheckUrl;

    public static String industryIdString;
    public static String enterpriseIdString;
    ...
    public ConfigUtil(Context context, String propertiesFileName) {
        mContext = context;
        mResources = context.getResources();
    ...
    protected void loadPropertiesValues() {
        Class<? extends ConfigUtil> thisClass = this.getClass();
